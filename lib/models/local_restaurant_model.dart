...
LocalRestaurantModel localRestaurantModelFromJson(String str) => LocalRestaurantModel.fromJson(json.decode(str));

String localRestaurantModelToJson(LocalRestaurantModel data) => json.encode(data.toJson());
...
class LocalRestaurantModel {
    ...
    factory LocalRestaurantModel.fromJson(Map<String, dynamic> json) => LocalRestaurantModel(
